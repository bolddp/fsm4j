...
public interface StateMachineListener<TriggerType, ContextType> {
	 ...
	 */
	default void onTransitioning(ContextType context,
			Class<? extends FsmState<TriggerType, ContextType>> sourceState,
	 ...
	 */
	default void onInvalidTrigger(
			ContextType context,
			TriggerType trigger,
			Class<? extends FsmState<TriggerType, ContextType>> stateClass) {
